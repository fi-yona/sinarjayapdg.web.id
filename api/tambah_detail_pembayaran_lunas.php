...
// update barang_lunas = banyak_barang_bayar dan status_barang = "Lunas" untuk id_pesanan dan id_barang pada tb_detail_pesanan
    ...
    if ($tokenResult->num_rows > 0) {
        ...
        if ($tambahDetailPembayaranResult) {
            $updateDetailPesananQuery = "UPDATE tb_detail_pesanan 
                                            SET barang_lunas = '$banyak_barang_bayar', status_barang = 'Lunas'
                                            WHERE id_barang = '$id_barang' AND id_pesanan = '$id_pesanan'";
