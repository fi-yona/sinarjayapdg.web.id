                ...
                <div class="box-green-1">
                    <form id="form-edit-data-karyawan" class="table-form-add" action="../../../function/edit-data-karyawan.php?id_karyawan=<?php echo $id_karyawan; ?>" method="POST">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th>No KTP</th>
                                <td><input type="text" placeholder="Nomor NIK KTP" name="no_ktp" id="no_ktp" class="input-text-add" value="<?php echo $row['no_ktp']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Nama Lengkap</th>
                                <td><input type="text" placeholder="Nama Sesuai KTP" name="nama_lengkap" id="nama_lengkap" class="input-text-add" value="<?php echo $row['nama_lengkap']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Nama Panggilan</th>
                                <td><input type="text" placeholder="Panggilan" name="nama_panggilan" id="nama_panggilan" class="input-text-add" value="<?php echo $row['nama_panggilan']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Tempat Lahir</th>
                                <td><input type="text" placeholder="Kota/Daerah" name="tempat_lahir" id="tempat_lahir" class="input-text-add" value="<?php echo $row['tempat_lahir']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Tanggal Lahir</th>
                                <td><input type="text" placeholder="Tahun-Bulan-Hari" name="tanggal_lahir" id="tanggal_lahir" class="input-text-add tanggal-penugasan" value="<?php echo $row['tanggal_lahir']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Jenis Kelamin</th>
                                <td>
                                    <select name="jk" id="jk" class="input-text-add" readonly>
                            ...
                            <tr>
                                <th>Agama</th>
                                <td>
                                    <select name="agama" id="agama" class="input-text-add" readonly>
                            ...
                            <tr>
                                <th>Status</th>
                                <td>
                                    <select name="status" id="status" class="input-text-add" readonly>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="pendidikan_terakhir" id="pendidikan_terakhir" class="input-text-add" readonly>
                            ...
                            <tr>
                                <th>No Telepon</th>
                                <td><input type="text" placeholder="No Whatsapp" name="no_telp" id="no_telp" class="input-text-add" value="<?php echo $row['no_telp']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <td><input type="text" placeholder="Email Pribadi" name="email" id="email" class="input-text-add" value="<?php echo $row['email']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Alamat Saat Ini</th>
                                <td><textarea placeholder="Alamat Tempat Tinggal Saat Ini" name="domisili" id="domisili" class="input-text-add" rows="10" readonly><?php echo $row['domisili']; ?></textarea></td>
                            </tr>
                            <tr>
                                <th>Jabatan</th>
                                <td><input type="text" placeholder="Jabatan di Perusahaan" name="jabatan" id="jabatan" class="input-text-add" value="<?php echo $row['jabatan']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Tanggal Diterima</th>
                                <td><input type="text" placeholder="Tahun-Bulan-Hari" name="tanggal_diterima" id="tanggal_diterima" class="input-text-add tanggal-penugasan" value="<?php echo $row['tanggal_diterima']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Tanggal Berhenti</th>
                                <td><input type="text" placeholder="Tahun-Bulan-Hari" name="tanggal_berhenti" id="tanggal_berhenti" class="input-text-add tanggal-penugasan" value="<?php echo $row['tanggal_berhenti']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Foto</th>
                                <td><input type="text" placeholder="Link Foto" name="foto_karyawan" id="foto_karyawan" class="input-text-add" value="<?php echo $row['foto_karyawan']; ?>" readonly></td>
                            </tr>
                        </table>
